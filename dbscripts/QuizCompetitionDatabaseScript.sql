...
(
	...
	CONSTRAINT [FK_USER_ROLE] FOREIGN KEY ([UserRole]) REFERENCES [t_role] (RoleId)
...
(
	...
	CONSTRAINT [PK_OPTIONS] PRIMARY KEY CLUSTERED ([OptionId] ASC),
...
(
    QQId INT IDENTITY(1,1) NOT NULL,
	QuizId INT NOT NULL,
    QuestionId INT  NOT NULL,
  
    
	CONSTRAINT [PK_QQ] PRIMARY KEY CLUSTERED ([QQId] ASC),
